...
class TestMultiPointFeatureCollectionCreation(object):
    def setup(self):
        self.records = [
            {'geometry': '{"type": "MultiPoint","coordinates": [ [100.0, 0.0], [101.0, 1.0] ]}', 'hoods_': 2.0}
        ]
    ...
    def test_encoding(self):
        ...
        constructor = GeoJSONConstructor(self.records, 'geometry')
        feature_collection = constructor.encode()
        expected_value = '{"type": "FeatureCollection", "features": [{"geometry": {"type": "MultiPoint", "coordinates": [[100.0, 0.0], [101.0, 1.0]]}, "type": "Feature", "properties": {"hoods_": 2.0}}]}'
        assert feature_collection == expected_value
